...
<?php foreach($trials as $i=>$trial) : ?>
	...
	<tr id="row_66" value="[0,1]" trialno="324"  style="display : none">
		...
		<td id="cell_66_1"><div align="center" ><img src="/webexp/img/CC/Blue_Circle.png"  alt="CC/Blue_Circle.png" width="200" height="200" /></div></td>
	</tr> 
	<tr id="row_67" value="[2,0]" trialno="376"  style="display : none">
		<td id="cell_67_0"><div align="center" ><img src="/webexp/img/CC/Yellow_Star.png"  alt="CC/Yellow_Star.png" width="200" height="200" /></div></td>
